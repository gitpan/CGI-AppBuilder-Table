# This Makefile is for the CGI::AppBuilder::Table extension to perl.
#
...
#     DISTNAME => q[CGI-AppBuilder-Table-0.12.tar.gz]
#     NAME => q[CGI::AppBuilder::Table]
#     PREREQ_PM => { Test::More=>q[0.45], Test::Harness=>q[0.1], CGI::AppBuilder=>q[0.11] }
#     VERSION => q[0.12]
#     test => { TESTS=>q[t/ab_Table.t] }
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = CGI::AppBuilder::Table
NAME_SYM = CGI_AppBuilder_Table
VERSION = 0.12
...
DISTNAME = CGI-AppBuilder-Table-0.12.tar.gz
DISTVNAME = CGI-AppBuilder-Table-0.12.tar.gz-0.12
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         CGI-AppBuilder-Table-0.12.tar.gz' >> META.yml
